...
{				
	...
	/*#app*/ this.RemoveDrawer = function( layout ) { prompt( "#", "App.RemoveDrawer(\f"+ layout.id ); }
	/*#app*/ this.DestroyDrawer = function( layout ) { prompt( "#", "App.DestroyDrawer(\f"+ layout.id ); }	
	...
	/*#app*/ this.CreateList = function( list,width,height,options ) { var ret = prompt( "#", "App.CreateList("+list+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Lst(ret); else return null; }	
	...
	/*#app*/ this.CreateWebGLView = function( width,height,options ) { var ret = prompt( "#", "App.CreateWebGLView(\f"+width+"\f"+height+"\f"+options );  if( ret ) return new WGL(ret); else return null; }	
	...
	/*#app*/ this.CreateSysProc = function( cmd ) { var ret = prompt( "#", "App.CreateSysProc(\f"+cmd ); if( ret ) return new Sys(ret); else return null; }	
...
function Img( id )
{
    ...
    /*#img*/ obj.SetName = function( name ) { prompt( obj.id, "Img.SetName("+name ); }
    /*#img*/ obj.GetName = function() { return prompt( obj.id, "Img.GetName(" ); }
