<?php
/**
* This class is used to manage the accessor
* layer of our models. Creating, deleting,
* or general genarations are handled here.
*/
...
class accessor
{
	...
	protected static $directory = "app/models/accessors/";
	...
	{
		shell::write(" description", "white").shell::write(" - ").shell::write("This command is used to manage accessor models. \n", "dark_grey");
	}
	...
	{
		shell::write(" make", "light_green").shell::write("        - ").shell::write("Used to generate an accessor model class. \n", "light_red");
	...
	public static function make($name = '', $type = 'empty')
	{
		...
		{
			case 'empty':
				$template = app::view()->make('templates.code.accessor.accessor-empty', ['name' => $name]);
	...
	{
		shell::write(" delete", "light_green").shell::write("      - ").shell::write("Used to delete an accessor model class. \n", "light_red");
