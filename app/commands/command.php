...
/**
* This is the command that is used to generate
* classes in the SECC\Commands namespace.
*/
...
class command
{
	...
	// Store the path to the commands directory
	protected static $directory = 'app/commands/';
	...
	{
		shell::write(" description", "white").shell::write(" - ").shell::write("This command is used to manage commands within LACE. \n", "dark_grey");
	}
	...
	{
		shell::write(" make", "light_green").shell::write("        - ").shell::write("Enter the name of the command that you would like to create. \n", "light_red");
	...
	public static function make($name = '', $type = 'empty')
	{
		...
		{
			case 'empty':
				$template = app::view()->make('templates.code.command.command-empty', ['name' => $name]);
	...
	{
		shell::write(" delete", "light_green").shell::write("      - ").shell::write("Enter the name of the command that you would like to delete. \n", "light_red");
